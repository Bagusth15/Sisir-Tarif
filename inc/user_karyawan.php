...
$sql_karyawan = mysqli_query($db, "SELECT * FROM user WHERE hak_akses = 'Karyawan' ") or die ($db->error);
$no = 1;
?>
<?php if (@$_GET['action'] == ''): ?>
  <div class="content-wrapper">
    ...
    <div class="row">
      <div class="col-12 grid-margin">
        <div class="card">
          <div class="card-body">
            <a href="?page=user_karyawan&action=tambah_karyawan" class="btn btn-outline-primary btn-icon-text btn-sm">
              <i class="mdi mdi-account-plus btn-icon-prepend"></i>
              Tambah Data
            </a>
            <a href="./laporan/cetak_karyawan.php" target="_blank" class="btn btn-outline-primary btn-icon-text btn-sm">
            ...
            <div class="table-responsive ">
              <table class="table" id="myTable">
                ...
                <tbody>
                  <?php while($data_karyawan = mysqli_fetch_array($sql_karyawan)) { ?>
                    <tr>
                      <td><?= $no++; ?>  </td>
                      <td>
                        <img src="images/foto/<?= $data_karyawan['gambar']; ?>" class="mr-2" alt="image">
                      ...
                      <td>
                        <a href="?page=user_admin&action=detail&nik=<?= $data_karyawan['nik']; ?>" class="badge badge-gradient-primary" style="text-decoration: none;">Detail</a>
                        <a href="?page=user_karyawan&action=edit_karyawan&nik=<?= $data_karyawan['nik']; ?>" class="badge badge-gradient-success" style="text-decoration: none;">Edit</a>
                        <a href="?page=user_karyawan&action=hapus_karyawan&nik=<?php echo $data_karyawan['nik']; ?>" class="badge badge-gradient-danger tombol-hapus" style="text-decoration: none;">Hapus</a>
                      </td>
                    </tr>
                  <?php } ?>
                </tbody>
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-12">
                ...
                <a href="?page=user_karyawan&action=edit_karyawan&nik=<?= $data['nik']; ?>" class="btn btn-gradient-success btn-block">Edit</a>
                <a href="?page=user_karyawan" class="btn btn-gradient-primary btn-block">Kembali</a>
              </div>
            </div>
          </div>
        </div>
...
<?php elseif (@$_GET['action'] == 'tambah_karyawan'): ?>
    <div class="content-wrapper">
      <div class="page-header">
        <h3 class="page-title">
      ...
      <div class="row">
        <div class="col-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <form class="forms-sample" method="post" action="?page=user_karyawan&action=proses_tambah" enctype="multipart/form-data">
                ...
                <a href="?page=user_karyawan" class="btn btn-gradient-danger">Cancel</a>
              </form>
            </div>
          </div>
        </div>
...
<?php elseif (@$_GET['action'] == 'proses_tambah'): ?>
      ...
      if(mysqli_num_rows($sql_cek_user) > 0) {
        ...
        if($ukuran < 1044070){      
          ...
          mysqli_query($db, "INSERT INTO user VALUES(
            ...
            now() )
            ") or die ($db->error);          
          echo '<script>window.location="?page=user_karyawan"</script>';
        }else{
      ...
      ?>
<?php elseif (@$_GET['action'] == 'edit_karyawan'): ?>
        <div class="content-wrapper">
          <div class="page-header">
            <h3 class="page-title">
              Edit User karyawan
          ...
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <form class="forms-sample" method="post" action="?page=user_karyawan&action=proses_edit" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="nik">NIK</label>
...
<?php elseif (@$_GET['action'] == 'proses_edit'): ?>
          ...
          ?>
<?php elseif (@$_GET['action'] == 'hapus_karyawan'): ?>
  <?php  
