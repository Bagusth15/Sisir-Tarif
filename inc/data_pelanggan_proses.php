  ...
  $dataa = mysqli_fetch_array($sql_per_id);
  ?>
  <?php  
  ...
  $sql_hasil_1 = mysqli_query($db, "SELECT * FROM data_hasil WHERE hasil = 'Sesuai' ") or die ($db->error);
  $sql_hasil_2 = mysqli_query($db, "SELECT * FROM data_hasil WHERE hasil = 'Tidak Sesuai' ") or die ($db->error);
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="border-bottom text-center pb-4">
                  <!-- <img src="images/foto/<?= $dataa['gambar']; ?>" alt="profile" class="img-lg rounded-circle mb-3" />
                  <p><?= $dataa['nama_lengkap']; ?></p> -->
                ...
                <div class="p-3">
                    <p class="clearfix">
                      ...
                      <span class="float-right text-muted"> <?= $dataa['id_pel']; ?> </span>
                    </p>
                    <p class="clearfix">
                      <span class="float-left"> Nama Lengkap </span>
                      <span class="float-right text-muted"> <?= $dataa['nama']; ?> </span>
                    </p>
                    <p class="clearfix">
                      <span class="float-left"> Alamat </span>
                      <span class="float-right text-muted"> <?= $dataa['alamat_pel']; ?> </span>
                    </p>
                    <p class="clearfix">
                      <span class="float-left"> No. Telp </span>
                      <span class="float-right text-muted"> <?= $dataa['no_telp_pel']; ?> </span>
                    </p>
                    <p class="clearfix">
                      <span class="float-left"> Keterangan </span>
                      <span class="float-right text-muted"><?= $dataa['keterangan']; ?></span>
                    </p>
                    <hr>
                    <p class="clearfix text-center">
                    <?php if ($data_hasil_1 < $data_hasil_2): ?>
                      <span>Dari pemrosesan data pelanggan, dapat dihasilkan bahwa pelanggan dengan id pel <?= $dataa['id_pel']; ?> <b>TIDAK SESUAI</b> dalam pemakaian listrik golongan bisnis. Dan pelanggan diwajibkan untuk memberikan surat keterangan usaha.</span>
                      <?php else: ?>
                        <span>Dari pemrosesan data pelanggan, dapat dihasilkan bahwa pelanggan dengan id pel <?= $dataa['id_pel']; ?> <b>SESUAI</b> dalam pemakaian listrik golongan bisnis.</span>
                      <?php endif ?>
                    </p>
                    <!-- <span>Dari pemrosesan data pelanggan, dapat dihasilkan bahwa pelanggan dengan id pel <?= $dataa['id_pel']; ?> <b>TIDAK SESUAI</b> dalam pemakaian listrik golongan bisnis. Dan pelanggan diwajibkan untuk memberikan surat keterangan usaha.</span> -->
                  </p>
      ...
      <div class="col-12">
          <!-- <div class="card">
            <div class="card-body">
              ...
              $data_hasil_2 = mysqli_num_rows($sql_hasil_2);
              ?>
              <p>Dari hasil perhitungan menggunakan metode K-NN diketahui nilai k = <?= $k; ?>, <br> dan didapatkan hasil : Sesuai = <?= $data_hasil_1; ?>, Tidak Sesuai = <?= $data_hasil_2; ?></p>
            </div>
          </div> -->
